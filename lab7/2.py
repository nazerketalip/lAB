...
icon = pygame.image.load('/Users/nazerkeabubakirovna/PycharmProjects/spotify.png')
pygame.display.set_icon(icon)
cover = pygame.image.load('/Users/nazerkeabubakirovna/PycharmProjects/medin.webp')
new_cover = pygame.transform.scale(cover, (400, 500))
player = pygame.image.load('/Users/nazerkeabubakirovna/PycharmProjects/player.png')
