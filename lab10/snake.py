...
bg = pg.image.load("/Users/nazerkeabubakirovna/PP2/background.jpg")
bg = pg.transform.scale(bg, (w, h))
gameover = pg.image.load("/Users/nazerkeabubakirovna/PP2/game_over.jpg")
gameover = pg.transform.scale(gameover, (390, 390))
cur_sc = 0
pg.mixer.init()
pg.mixer.music.load("/Users/nazerkeabubakirovna/PP2/labz_lab10_music_backsound.mp3")
...
class Food:
    ...
    def draw2(self):
        ...
        self.y = randrange(0, h, step)
        self.r = randint(1, 3)
        self.image = pg.image.load(f'/Users/nazerkeabubakirovna/PP2/food{self.r}.png')
...
class Snake:
    ...
    def collide_food(self, f: Food):
        if self.body[0][0] == f.x and self.body[0][
            ...
            pg.mixer.Sound('/Users/nazerkeabubakirovna/PP2/labz_lab10_music_eat.mp3').play()
            global rush
            rush = True
    ...
    def self_collide(self):
        ...
        if self.body[0] in self.body[1:]:  # если голова змейки и входит в массив координат тела змейки
            ...
            pg.mixer.music.stop()
            pg.mixer.Sound('/Users/nazerkeabubakirovna/PP2/labz_lab10_music_gameover.wav').play()
            pg.mixer.music.stop()
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pg.image.load("/Users/nazerkeabubakirovna/PP2/wall.png")
...
s = Snake()
f = Food(pg.image.load(f'/Users/nazerkeabubakirovna/PP2/food{randint(1, 3)}.png'))
disappear(5000)
